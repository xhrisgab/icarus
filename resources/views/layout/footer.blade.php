<div class="container-fluid footer mt-5 pt-5 px-0 position-relative overlay-top">
    <div class="container-fluid text-center border-top mt-4 py-4 px-sm-3 px-md-5" style="border-color: rgba(256, 256, 256, .1) !important;">
        <p class="mb-2>Copyright &copy; <a class="font-weight-bold" href="#">Icarus-UMSA</a>. All Rights Reserved.</a></p>
        <p class="m-0">Designed by <a class="font-weight-bold" href="https://icarus.info">Icarus</a></p>
    </div>
</div>
